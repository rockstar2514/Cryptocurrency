		...
		public static void checkTransaction(String dir)throws Exception{
			...
			if(f.exists()){
			  ...
			  //  System.out.println(n);
			    ...
			    {
			          System.out.println(inflow[i].ID);
			          System.out.println(inflow[i].index);
			          System.out.println(inflow[i].length);
			          System.out.println(inflow[i].signature);
			    }
			    for(int i=0;i<ops.length;i++)
			    {
			          System.out.println(ops[i].coins);
			          System.out.println(ops[i].length);
			          System.out.println(ops[i].publicKey);
			         // System.out.println(inflow[i].signature);
			    }
			    reader.close();
			}
