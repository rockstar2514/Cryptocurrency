...
public class Util {
	public static void append(ArrayList< Byte> li, byte[] arr){
		for(int i=0;i<arr.length;i++){
			li.add(arr[i]);// Appends at the end of Array List//TODO test this
		}
	}
	...
	public static byte[] toByte(int n){//does not work for negative numbers
		if(n<0)
			return null;
    ...
    public static PrivateKey getPrivateKey(String dir) {
    	try
    	{
	...
	public static int cmpHex(String s1,String s2) {
