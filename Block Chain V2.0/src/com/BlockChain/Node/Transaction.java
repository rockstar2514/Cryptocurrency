...
public class Transaction {
	//TODO make a transaction directory where all files will be stored
	...
	public static Transaction getTrans(int inp,String TID[], int outputind[],String signs[],int ops,long coinlist[],String locs[]) throws NoSuchAlgorithmException, IOException {
		if(inp<=0||ops<=0) {
	...
	public static Transaction getTransaction(String path) throws NoSuchAlgorithmException, IOException {
	...
	public static void main(String args[]) throws NoSuchAlgorithmException, IOException
	{
	    ...
	    Transaction t2=getTrans(p1,p2,p3,p4,p5,p6,p7);
	    t2.getReceipt();
	}
